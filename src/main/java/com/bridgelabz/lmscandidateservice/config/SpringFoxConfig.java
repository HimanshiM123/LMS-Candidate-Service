package com.bridgelabz.lmscandidateservice.config;
...
public class SpringFoxConfig implements WebMvcConfigurer{
   ...
   public Docket api() {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.lmscandidateservice.controller"))
   ...
   /*private ApiInfo getApiInfo() {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfo("LMS-Candidate-Service",
                ...
                new Contact("LMS-Candidate-Service", "http://bridgelabz.lmscandidateservice", "himanshi1252@gmail.com"),
